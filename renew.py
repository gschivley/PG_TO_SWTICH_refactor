...
for region in egional_fuel_adjustments.keys():
    for i in range(len(fuel_cost)):
        if fuel_cost['load_zone'].iloc[i] == region and fuel_cost['fuel'].iloc[i] == 'Coal':
...
energy_tech = {'Onshore Wind Turbine': 'Wind', 'Biomass': 'Bio Solid', 'Conventional Hydroelectric': 'Water', 
                'Conventional Steam Coal': 'Coal', 'Natural Gas Fired Combined Cycle': 'Natural Gas', 
                'Natural Gas Fired Combustion Turbine': 'Natural Gas', 'Natural Gas Steam Turbine': 'Natural Gas',
                ...
                'NaturalGas_CCCCSAvgCF_Conservative': 'Natural Gas', 'NaturalGas_CCAvgCF_Moderate': 'Natural Gas', 
                'NaturalGas_CTAvgCF_Moderate': 'Natural Gas', 'Battery_*_Moderate': 'Electricity', 
                'NaturalGas_CCS100_Moderate': 'Natural Gas', 'heat_load_shifting': False}
